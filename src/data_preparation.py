...
def preprocess_data(input_path=INPUT_CSV, output_dir=OUTPUT_DIR):
    ...
    # Se elimina variable Defualt ya que tiene muchos valores desconocidos
    df.drop(columns=["default"], inplace=True)

    # Se hace un filtro para elimnar las filas que tiene valores nulos
...
if __name__ == "__main__":
    ...
    with open('docs/transformations.txt', 'w') as f:
        ...
        f.write("Se eliminó la variables default debido a la alta candtida de valores nulos")
